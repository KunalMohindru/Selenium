...
public class Navgtion_After_Markng_Fav {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		// Hover over favorite button so that your favorite appears
				
				Actions view_Fav = new Actions (driver);
				view_Fav.moveToElement(driver.findElement(By.xpath("//*[@id=\"13451272_16930708348\"]")));
				
		// Tap on Your Favorites
				
				Wait.until(ExpectedConditions.visibilityOf(driver.findElement(By.xpath("//*[@id=\"divToolTip\"]/a")))).click();
